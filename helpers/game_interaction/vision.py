...
class Vision(StealthMode):
    ...
    def capture_text(self, read_coords: List[int], update: bool = False, testing: bool = False) -> str:
        ...
        img_downstream = Image.fromarray(image)
        img.save(f'debug/{read_coords}debug.png')

        return img_downstream
...
def read_image_text(image: Image.Image, psm: int = 6, oem: int = 1, char_white_list: str = "0123456789k-:") -> str:
    """
